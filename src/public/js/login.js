...
document.querySelector("#overview-li").style.display = "none";
document.querySelector("#budget-li").style.display = "none";
document.querySelector("#income-li").style.display = "none";
document.querySelector("#thismonth-li").style.display = "none";
